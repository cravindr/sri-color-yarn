...
require_once ('report/print_div_open.php');    //for print tage open
//echo $output ;
require_once ('report/inv_report_out_print.php'); // for print tage close and Set Ttitle
...
require_once ('report/report_out_js.php');
