            ...
            <div class="x_content">
                <div class="row">
                   <!-- <form class="form-horizontal form-label-left input_mask" method="post" enctype="multipart/form-data" action="<?php /*echo site_url('report/generate');*/?>">-->
                    <form class="form-horizontal form-label-left input_mask" method="post" enctype="multipart/form-data" action="<?php echo site_url('report/gentransation');?>">
