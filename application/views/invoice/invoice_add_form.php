...
<div class="row">
    <div class="col-md-12 col-lg-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    <form class="form-horizontal form-label-left input_mask" method="post" enctype="multipart/form-data" action="<?php echo site_url('invoice/invoicesave');?>">
                            ...
                            <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <table id="productinv" class="table table-bordered">
                                            ...
                                            <tr>
                                                <th width="0.5%"></th>
                                                <th width="30%">Item Description &nbsp;<a href="" data-toggle="modal" data-target="#product_modal-add" title="New Product"><i class="fa fa-plus-circle" aria-hidden="true"></i></a></th>
