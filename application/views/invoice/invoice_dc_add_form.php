...
<div class="row">
    <div class="col-md-12 col-lg-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    <form class="form-horizontal form-label-left input_mask" method="post" enctype="multipart/form-data" action="<?php echo site_url('invoice/invoicedcsave');?>">
                        <div class="col-lg-6 col-md-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Choose Dc</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <select name="dc_no" id="dc_no" class="form-control selectpicker show-tick" title="Choose Delivery challan No" multiple>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        <table id="productinv" class="table table-bordered">
                                            ...
                                            <tr>
                                                <th width="0.5%"></th>
                                                <th width="40%">Item Description &nbsp;<a href="" data-toggle="modal" data-target="#product_modal-add" title="New Product"><i class="fa fa-plus-circle" aria-hidden="true"></i></a></th>
