...
{
    //echo "if"; exit;
    require_once ('report/transation_supplier_report_all_table_list.php');
}
else
{
    //echo "else"; exit;
    require_once('report/transation_supplier_report_table_list.php');
}
/// datatable header
...
require_once ('report/transation_supplier_datatables_js.php');               // datatable Javascript
