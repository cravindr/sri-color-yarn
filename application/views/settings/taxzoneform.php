<div class="container-fluid">
    <div class="row">
        <div class="col-lg-offset-4 col-lg-4 col-md-offset-4 col-md-4 col-xs-12" style="margin-top: 15%">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Tax Group<small>Add </small></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <form id="validate" action="<?php echo site_url('settings/save') ?>" method="post">
                        ...
                        <div class="form-group">
                            <select id="country" name="country" data-live-search="true" class="selectpicker form-control validate[required]" title="Select a Country">
                                <?php
