...
require_once('company/branch/company_branch_table_list.php');
...
require_once('company/branch/company_branch_datatables_js.php');
require_once ('common/body_close.php');

require_once ('company/branch/add_company_branch_edit_form.php');
