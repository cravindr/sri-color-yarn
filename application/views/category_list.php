...
require_once('product/category_table_list.php');               /// datatable header
...
require_once ('product/category_datatable.php');               // datatable Java
require_once ('common/body_close.php');

require_once ('common/html_open.php');
require_once ('product/modal_window_category.php');
?>
