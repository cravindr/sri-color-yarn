...
require_once('tax_zone/tax_table_list.php');                    // Tax table
...
require_once ('tax_zone/tax_datatable.php');                 // Tax table Url List and Js
require_once ('common/body_close.php');

require_once ('common/html_open.php');
require_once ('tax_zone/modal_window_tax.php');
?>
